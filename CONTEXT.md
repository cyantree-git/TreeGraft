...
- Company: CyanTree Ltd (cyantree.co.uk)
- Anonymous identity: th4tdevsid / th4tdevsid@proton.me
- GitHub: github.com/th4tdevsid/TreeGraft (working fork)
- Upstream: github.com/cyantree-git/TreeGraft (canonical)
- All work done under th4tdevsid identity, never Bloomberg identity
- SSH: use `github-th4tdevsid` alias for all git operations
...
No Rust. No Go. Pure TypeScript end to end.
